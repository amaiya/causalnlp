# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/05c_meta.slearner.ipynb (unless otherwise specified).

__all__ = ['StatsmodelsOLS', 'BaseSLearner', 'BaseSRegressor', 'BaseSClassifier', 'LRSRegressor', 'logger']
